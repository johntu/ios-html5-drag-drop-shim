...
(function() {
  ...
  var iosDragDrop = angular.module("iosDragDrop", []);

  iosDragDrop.provider("iosDragDrop", function() {

    var options = {};

    /**
     * This timeout will wait for any options to be set via the provider
     */
    setTimeout(function() {
      window.iosDragDropShim = options;
      init();
    });
